...
def get_categories(category_service: category_service_depends) -> List[Category]:
...
def get_category(category_service: category_service_depends, category_id: UUID) -> Category:
...
def update_category_endpoint(category_service: category_service_depends, category_id: UUID, payload: CategoryUpdate) -> Category:
...
def delete_category_endpoint(category_service: category_service_depends, category_id: UUID) -> None:
    """Delete a category.
