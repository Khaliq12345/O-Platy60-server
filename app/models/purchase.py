...
class PurchaseBase(BaseModel):
    ...
    """
    item_name: str = Field(..., description="Name of the purchased item", min_length=1, max_length=200)
...
class PurchaseUpdate(BaseModel):
    ...
    """
    item_name: str | None = Field(None, description="Updated item name", min_length=1, max_length=200)
    quantity: float | None = Field(None, description="Updated quantity", gt=0)
    unit: str | None = Field(None, description="Updated unit", min_length=1, max_length=50)
    price_per_unit: float | None = Field(None, description="Updated price per unit", ge=0)
...
class Purchase(PurchaseBase):
    ...
    created_by: UUID = Field(..., description="UUID of the user who created the purchase")
