...
class TransformationStepBase(BaseModel):
    ...
    """
    transformation_id: UUID = Field(..., description="Reference to the parent transformation")
...
class TransformationStepUpdate(BaseModel):
    ...
    """
    transformation_id: UUID | None = Field(None, description="Updated transformation reference")
...
class TransformationStep(TransformationStepBase):
    ...
    """
    id: UUID = Field(..., description="Unique transformation step identifier")
