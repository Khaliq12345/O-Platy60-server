...
from app.db.repositories.purchase_repository import (
    list_purchases,
    get_purchase_by_id,
    create_purchase,
    update_purchase,
...
def get_purchases() -> List[Purchase]:
    ...
    Returns:
        List[Purchase]: List of all purchases ordered by date (newest first)
...
def get_purchase(purchase_id: UUID) -> Purchase:
